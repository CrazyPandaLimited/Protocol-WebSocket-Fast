...
=head1 SYNOPSIS
    ...
    my $client = Protocol::WebSocket::XS::ClientParser->new; # => isa 'Protocol::WebSocket::XS::Parser'
...
Parses the server HTTP-response to the initial HTTP-requests. All supported extensions
