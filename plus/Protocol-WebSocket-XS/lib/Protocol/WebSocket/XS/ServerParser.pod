...
Developer might supply customized L<Protocol::WebSocket::XS::ConnectResponse> C<$response> with predefined headers, custom extensions, etc...
...
Developer might supply customized L<Protocol::WebSocket::XS::ConnectResponse> C<$object> with predefined headers, etc...
